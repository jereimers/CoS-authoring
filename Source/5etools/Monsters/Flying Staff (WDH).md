...
aliases: [Flying Staff (WDH)]
tags: [ai_generated, 5etools, monster, construct, cr-1/4]
type: monster
size: Small
...
**Hit Points** 17 (5d6)  
**Speed** fly 50 ft. (hover), canHover (equal to walking)
...
**Knife.** Melee Weapon Attack +3 to hit, reach 5 ft., one target. @h4 (**1d6 + 1**) bludgeoning damage.
