...
aliases: [Yagnoloth (MPMM)]
tags: [ai_generated, 5etools, monster, fiend, cr-11]
type: monster
size: Large
...
| **STR** 19 (+4) | **DEX** 14 (+2) | **CON** 21 (+5) | **INT** 16 (+3) | **WIS** 15 (+2) | **CHA** 18 (+4) |
...
**Electrified Touch.** Melee Weapon Attack +8 to hit, reach 5 ft., one target. @h27 (**6d8**) lightning damage.

**Massive Arm.** Melee Weapon Attack +8 to hit, reach 15 ft., one target. @h23 (**3d12 + 4**) force damage. If the target is a creature, it must succeed on a DC 16 Constitution saving throw or become [[stunned]] until the end of the yagnoloth's next turn.
