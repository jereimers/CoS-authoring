...
aliases: [Draconian Infiltrator (FTD)]
...
| **STR** 11 (+0) | **DEX** 17 (+3) | **CON** 14 (+2) | **INT** 9 (-1) | **WIS** 13 (+1) | **CHA** 11 (+0) |
...
**Dagger.** Melee or Ranged Weapon Attack +5 to hit, reach 5 ft. or range 20/60 ft., one target. @h5 (**1d4 + 3**) piercing damage plus 7 (**2d6**) poison damage.
