...
aliases: [Xvart Speaker (VGM)]
tags: [ai_generated, 5etools, monster, humanoid, cr-1/8]
type: monster
size: Small
monster_type: humanoid (xvart)
...
| **STR** 8 (-1) | **DEX** 14 (+2) | **CON** 10 (+0) | **INT** 13 (+1) | **WIS** 7 (-2) | **CHA** 7 (-2) |
...
**Shortsword.** Melee Weapon Attack +4 to hit, reach 5 ft., one target. @h5 (**1d6 + 2**) piercing damage.

**Sling.** Ranged Weapon Attack +4 to hit, range 30/120 ft., one target. @h4 (**1d4 + 2**) bludgeoning damage.
