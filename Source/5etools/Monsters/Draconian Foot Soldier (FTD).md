...
aliases: [Draconian Foot Soldier (FTD)]
...
| **STR** 13 (+1) | **DEX** 11 (+0) | **CON** 13 (+1) | **INT** 8 (-1) | **WIS** 8 (-1) | **CHA** 10 (+0) |
...
**Shortsword.** Melee Weapon Attack +3 to hit, reach 5 ft., one target. @h4 (**1d6 + 1**) piercing damage.
