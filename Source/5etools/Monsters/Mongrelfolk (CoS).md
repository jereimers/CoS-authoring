...
aliases: [Mongrelfolk (CoS)]
tags: [ai_generated, 5etools, monster, humanoid, cr-1/4]
type: monster
size: Medium
monster_type: humanoid (mongrelfolk)
alignment: Any
armor_class: 11
hit_points: 26
...
*Medium humanoid (mongrelfolk), Any*
...
| **STR** 12 (+1) | **DEX** 9 (-1) | **CON** 15 (+2) | **INT** 9 (-1) | **WIS** 10 (+0) | **CHA** 6 (-2) |
...
**Bite.** Melee Weapon Attack +3 to hit, reach 5 ft., one target. @h3 (**1d4 + 1**) piercing damage.

**Claw.** Melee Weapon Attack +3 to hit, reach 5 ft., one target. @h3 (**1d4 + 1**) slashing damage.

**Dagger.** Melee or Ranged Weapon Attack +3 to hit, reach 5 ft. or range 20/60 ft., one target. @h3 (**1d4 + 1**) piercing damage.
