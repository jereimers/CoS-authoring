...
The target can take a [[Study|XPHB]] action to examine the phantasm with an Intelligence ([[Investigation|XPHB]]) check against your spell save DC. If the check succeeds, the target realizes that the phantasm is an illusion, and the spell ends.
