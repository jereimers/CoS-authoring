...
aliases: [Retriever (MPMM)]
tags: [ai_generated, 5etools, monster, construct, cr-14]
type: monster
size: Large
...
**Damage Resistances** —  
**Damage Immunities** necrotic, poison, psychic, bludgeoning, piercing, slashing  
...
**Foreleg.** Melee Weapon Attack +11 to hit, reach 10 ft., one target. @h15 (**2d8 + 6**) slashing damage.
