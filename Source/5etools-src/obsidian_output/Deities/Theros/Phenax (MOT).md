...
aliases: [Phenax (MOT)]
tags: [ai_generated, 5etools, deity, theros]
type: deity
pantheon: Theros
...
Phenax is worshiped openly in the necropoleis of Asphodel and Odunos, though the Returned who are loyal to Erebos's agent, Tymaret, refuse to worship the god they're hunting (see [[chapter 3|MOT]]). Somber ceremonies are intoned to bless the golden funeral masks the Returned wear.
...
- [[Phenax's Devotee|MOT]]
- [[Phenax's Votary|MOT]]
- [[Phenax's Disciple|MOT]]
