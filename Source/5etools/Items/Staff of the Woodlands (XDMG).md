...
aliases: [Staff of the Woodlands (XDMG)]
...
*Item, Rare* *(requires attunement by a druid)*
...
You can take a [[Magic|XPHB]] action to plant one end of the staff in earth in an unoccupied space and expend 1 charge to transform the staff into a healthy tree. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius. The tree appears ordinary but radiates a faint aura of Transmutation magic that can be discerned with the [[Detect Magic|XPHB]] spell. While touching the tree and using a [[Magic|XPHB]] action, you return the staff to its normal form. Any creature in the tree falls when the tree reverts to a staff.
...
**Source:** 2024 Dungeon Master's Guide, p. 311
