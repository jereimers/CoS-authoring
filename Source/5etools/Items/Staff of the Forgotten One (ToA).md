...
source: ToA
source_full: Tomb of Annihilation
aliases: [Staff of the Forgotten One (ToA)]
...
*Item, Artifact* *(requires attunement by a sorcerer, warlock, or wizard)*

This crooked staff is carved from bone and topped with the skull of a forgotten [[archmage]] whom [[Acererak|ToA]] destroyed long ago. Etched into the skull's forehead is [[acererak|ToA]] rune, which is known on many worlds as a sign of death.
