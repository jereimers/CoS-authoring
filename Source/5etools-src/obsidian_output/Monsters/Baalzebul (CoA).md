...
| **STR** 28 (+9) | **DEX** 15 (+2) | **CON** 25 (+7) | **INT** 21 (+5) | **WIS** 24 (+7) | **CHA** 26 (+8) |
...
**Slam.** Melee Weapon Attack +17 to hit, reach 10 ft., one target. @h19 (**3d6 + 9**) bludgeoning damage plus 7 (**2d6**) necrotic damage.
