...
source: HotDQ
source_full: HotDQ
aliases: [Rezmir (HotDQ)]
tags: [ai_generated, 5etools, monster, humanoid, cr-7]
type: monster
size: Medium
monster_type: humanoid (half-black dragon)
...
| **STR** 18 (+4) | **DEX** 16 (+3) | **CON** 16 (+3) | **INT** 15 (+2) | **WIS** 12 (+1) | **CHA** 14 (+2) |
...
**Greatsword (Hazirawn).** Melee Weapon Attack +9 to hit, reach 5 ft., one target. @h13 (**2d6 + 6**) slashing damage plus 7 (**2d6**) necrotic damage. If the target is a creature, it can't regain hit points for 1 minute. The target can make a DC 15 Constitution saving throw at the end of each of its turns, ending this effect early on a success.

**Caustic Bolt.** Ranged Spell Attack +8 to hit, range 90 ft., one target. @h18 (**4d8**) acid damage.

**Acid Breath {@recharge 5}.** Rezmir breathes acid in a 30-foot line that is 5 feet wide. Each creature in the line must make a DC 14 Dexterity saving throw, taking 22 (**5d8**) acid damage on a failed save, or half as much damage on a successful one.
