...
aliases: [Vampire Warrior (MM)]
tags: [ai_generated, 5etools, monster, undead, cr-15]
type: monster
size: Medium
...
**Unarmed Strike (Vampire Form Only).** Melee Weapon Attack +9 to hit, reach 5 ft., one creature. @h8 (**1d8 + 4**) bludgeoning damage. Instead of dealing damage, the vampire can grapple the target (escape DC 18).

**Greatsword.** Melee Weapon Attack +9 to hit, reach 5 ft., one creature. @h11 (**2d6 + 4**) slashing damage.

**Bite (Bat or Vampire Form Only).** Melee Weapon Attack +9 to hit, reach 5 ft., one willing creature, or a creature that is [[grappled]] by the vampire, [[incapacitated]], or [[restrained]]. @h7 (**1d6 + 4**) piercing damage plus 10 (**3d6**) necrotic damage. The target's hit point maximum is reduced by an amount equal to the necrotic damage taken, and the vampire regains hit points equal to that amount. The reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0. A humanoid slain in this way and then buried in the ground rises the following night as a [[vampire spawn]] under the vampire's control.
