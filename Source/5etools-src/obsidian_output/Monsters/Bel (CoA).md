...
source_full: CoA
aliases: [Bel (CoA)]
tags: [ai_generated, 5etools, monster, fiend, cr-25]
type: monster
size: Large
...
**Greatsword.** Melee Weapon Attack +17 to hit, reach 10 ft., one target. @h23 (**4d6 + 9**) slashing damage plus 21 (**6d6**) fire damage. If the target is a flammable object that isn't being held or worn, it catches fire.

**Tail.** Melee Weapon Attack +17 to hit, reach 10 ft., one target. @h25 (**3d10 + 9**) bludgeoning damage. If the target is a creature, it must succeed on a DC 23 Constitution saving throw or have the [[stunned]] condition until the end of its next turn.
