...
source: MaBJoV
source_full: MaBJoV
aliases: [Wolfwere (MaBJoV)]
tags: [ai_generated, 5etools, monster, humanoid, cr-4]
type: monster
size: Medium
...
| **STR** 18 (+4) | **DEX** 14 (+2) | **CON** 12 (+1) | **INT** 10 (+0) | **WIS** 8 (-1) | **CHA** 15 (+2) |
...
**Longsword (Humanoid form only).** Melee Weapon Attack +7 to hit, reach 5 ft., one target. @h9 (**1d8 + 4**) slashing damage or 10 (**1d10 + 5**) slashing damage if used with two hands.

**Bite (Wolf or Hybrid form only).** Melee Weapon Attack +7 to hit, reach 5 ft., one target. @h11 (**2d6 + 4**) piercing damage. If the target is a creature, it must succeed on a DC 14 Strength saving throw or be knocked [[prone]].

**Claws (Hybrid form only).** Melee Weapon Attack +7 to hit, reach 5 ft., one target. @h9 (**2d4 + 4**) slashing damage.
