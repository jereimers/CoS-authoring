...
type: monster
size: Medium
monster_type: humanoid (aarakocra)
...
| **STR** 10 (+0) | **DEX** 14 (+2) | **CON** 10 (+0) | **INT** 14 (+2) | **WIS** 17 (+3) | **CHA** 11 (+0) |
...
**Talon.** Melee Weapon Attack +4 to hit, reach 5 ft., one target. @h4 (**1d4 + 2**) slashing damage.

**Javelin.** Melee or Ranged Weapon Attack +4 to hit, reach 5 ft. or range 30/120 ft., one target. @h5 (**1d6 + 2**) piercing damage.
