...
aliases: [Yagra Stonefist (WDH)]
tags: [ai_generated, 5etools, monster, humanoid, cr-1/2]
type: monster
size: Medium
monster_type: humanoid (half-orc)
alignment: Neutral
armor_class: 11
hit_points: 32
...
**Armor Class** 11 ([[leather armor|phb]])  
...
**Mace.** Melee Weapon Attack +4 to hit, reach 5 ft., one creature. @h5 (**1d6 + 2**) bludgeoning damage.
