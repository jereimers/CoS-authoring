...
aliases: [Hellfire Engine (MPMM)]
tags: [ai_generated, 5etools, monster, construct, cr-16]
type: monster
size: Huge
...
| **STR** 20 (+5) | **DEX** 16 (+3) | **CON** 24 (+7) | **INT** 2 (-4) | **WIS** 10 (+0) | **CHA** 1 (-5) |
...
- **3–4: Lightning Flail:** Melee Weapon Attack +10 to hit, reach 15 ft., one creature. @h18 (**3d8 + 5**) bludgeoning damage plus 22 (**5d8**) lightning damage. Up to three other creatures of the hellfire engine's choice that it can see within 30 feet of the target must each make a DC 20 Dexterity saving throw, taking 22 (**5d8**) lightning damage on a failed save, or half as much damage on a successful one.
