...
| **STR** 9 (-1) | **DEX** 16 (+3) | **CON** 13 (+1) | **INT** 11 (+0) | **WIS** 10 (+0) | **CHA** 12 (+1) |
...
**Scimitar.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h6 (**1d6 + 3**) slashing damage.
