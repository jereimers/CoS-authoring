...
aliases: [Duergar Hammerer (MTF)]
tags: [ai_generated, 5etools, monster, construct, cr-2]
type: monster
size: Medium
...
**Claw.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h6 (**1d6 + 3**) bludgeoning damage.

**Hammer.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h10 (**2d6 + 3**) bludgeoning damage.
