...
- There's a hayloft (map area h) above the stable in which hundreds of ravens roost overnight. It contains a chest, which the ravens seem to protect, and a secret door that connects to the inn's master bedroom.
