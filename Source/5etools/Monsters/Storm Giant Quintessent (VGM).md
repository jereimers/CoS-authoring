...
aliases: [Storm Giant Quintessent (VGM)]
tags: [ai_generated, 5etools, monster, giant, cr-16]
type: monster
size: Huge
monster_type: giant (storm giant)
...
**Speed** walk 50 ft., fly 50 ft. (hover), swim 50 ft., canHover (equal to walking)

---

| **STR** 29 (+9) | **DEX** 14 (+2) | **CON** 20 (+5) | **INT** 17 (+3) | **WIS** 20 (+5) | **CHA** 19 (+4) |
...
**Lightning Sword.** Melee Weapon Attack +14 to hit, reach 15 ft., one target. @h40 (**9d6 + 9**) lightning damage.
