...
aliases: [Slithering Tracker (VGM)]
tags: [ai_generated, 5etools, monster, ooze, cr-3]
type: monster
size: Medium
monster_type: ooze
...
| **STR** 16 (+3) | **DEX** 19 (+4) | **CON** 15 (+2) | **INT** 10 (+0) | **WIS** 14 (+2) | **CHA** 11 (+0) |
...
**Slam.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h8 (**1d10 + 3**) bludgeoning damage.
