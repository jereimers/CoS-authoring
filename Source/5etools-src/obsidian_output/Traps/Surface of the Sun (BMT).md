...
aliases: [Surface of the Sun (BMT)]
...
The plants that cover the walls are fragile from the scorching light and not helpful for climbing. A character must succeed on a DC 12 Strength ([[Athletics]]) check to climb the walls.
