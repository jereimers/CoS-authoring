...
aliases: [Zi Liang (SKT)]
tags: [ai_generated, 5etools, monster, humanoid, cr-0]
type: monster
size: Medium
...
| **STR** 12 (+1) | **DEX** 15 (+2) | **CON** 11 (+0) | **INT** 14 (+2) | **WIS** 16 (+3) | **CHA** 11 (+0) |
...
**Quarterstaff.** Melee Weapon Attack +3 to hit, reach 5 ft., one target. @h4 (**1d6 + 1**) bludgeoning damage, or 5 (**1d8 + 1**) bludgeoning damage if used with both hands.

**Sling.** Ranged Weapon Attack +4 to hit, range 30/120 ft., one target. @h4 (**1d4 + 2**) bludgeoning damage. Zi carries twenty sling stones.
