...
If an item requires an action to activate, that action isn't a function of the [[Use an Object]] action, so a feature such as the rogue's [[Fast Hands|Rogue]] can't be used to activate the item.
