...
name: Tomb Tapper
source: IDRotF
source_full: "Icewind Dale: Rime of the Frostmaiden"
aliases: [Tomb Tapper (IDRotF)]
tags: [ai_generated, 5etools, monster, construct, cr-10]
type: monster
size: Huge
...
| **STR** 22 (+6) | **DEX** 10 (+0) | **CON** 21 (+5) | **INT** 14 (+2) | **WIS** 14 (+2) | **CHA** 11 (+0) |
...
**Bite.** Melee Weapon Attack +10 to hit, reach 5 ft., one target. @h22 (**3d10 + 6**) slashing damage.

**Claw.** Melee Weapon Attack +10 to hit, reach 10 ft., one target. @h16 (**3d6 + 6**) slashing damage.

**Sledgehammer.** Melee or Ranged Weapon Attack +10 to hit, reach 15 ft. or range 30/120 ft., one target. @h27 (**6d6 + 6**) bludgeoning or force damage (tomb tapper's choice). If thrown, the hammer returns to the tomb tapper at the end of its turn, landing at the tomb tapper's feet if it doesn't have a hand free to catch the weapon.
