...
source: FRHoF
source_full: FRHoF
aliases: ["Songal's Elemental Suffusion (FRHoF)"]
tags: [ai_generated, 5etools, spell, transmutation, level-5]
type: spell
level: 5
...
- **Elemental Immunity:** When you cast this spell, choose one of the following damage types: Acid, Cold, Fire, Lightning, or Thunder. You have [[Resistance|XPHB]] to the chosen damage type.
- **Elemental Pulse:** When you cast this spell and at the start of each of your subsequent turns, you release a burst of elemental energy in a 15-foot [[Emanation [Area of Effect]|XPHB]] originating from yourself. Each creature of your choice in that area makes a Dexterity saving throw. On a failed save, a creature takes **2d6** Acid, Cold, Fire, Lightning, or Thunder damage (your choice) and has the [[Prone|XPHB]] condition. On a successful save, a creature takes half as much damage only.
- **Flight:** You gain a [[Fly Speed|XPHB]] of 30 feet and can hover.
