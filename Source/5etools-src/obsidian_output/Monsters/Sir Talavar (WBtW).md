...
aliases: [Sir Talavar (WBtW)]
tags: [ai_generated, 5etools, monster, dragon, cr-2]
type: monster
size: Tiny
monster_type: dragon
...
**Superior Invisibility.** As a bonus action, Sir Talavar can magically turn [[invisible]] until his [[concentration]] ends (as if [[concentration]] on a spell). Any equipment Sir Talavar wears or carries is [[invisible]] with him.
...
**+1 Tiny Sword.** Melee Weapon Attack +8 to hit, reach 5 ft., one target. @h8 (**1d4 + 6**) piercing damage.

**Bite.** Melee Weapon Attack +7 to hit, reach 5 ft., one creature. @h1 piercing damage.
