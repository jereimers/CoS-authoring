...
aliases: [Frost Giant Everlasting One (MPMM)]
tags: [ai_generated, 5etools, monster, giant, cr-12]
type: monster
size: Huge
monster_type: giant
...
| **STR** 25 (+7) | **DEX** 9 (-1) | **CON** 24 (+7) | **INT** 9 (-1) | **WIS** 10 (+0) | **CHA** 12 (+1) |
...
**Greataxe.** Melee Weapon Attack +11 to hit, reach 10 ft., one target. @h26 (**3d12 + 7**) slashing damage, or 30 (**3d12 + 11**) slashing damage while raging.

**Rock.** Ranged Weapon Attack +11 to hit, range 60/240 ft., one target. @h29 (**4d10 + 7**) bludgeoning damage.
