...
- **Equipment::** An Izzet insignia, one set of artisan's tools, the charred and twisted remains of a failed experiment, a [[hammer|phb]], a [[block and tackle|phb]], a set of [[common clothes|phb]], and a belt [[pouch|phb]] containing 5 gp (Azorius 1-zino coins)
...
| 1st | [[chaos bolt|XGE]], [[create or destroy water]], [[unseen servant]] |
...
If you use an arcane focus, it probably takes the form of an intricate device that could include metal gauntlets, glass canisters, copper tubing, and leather straps attaching it to your body. The [[mizzium apparatus|GGR]] described in [[chapter 5|GGR]] is a magical version of this gear.

The [[chaos bolt|XGE]] spell is a favorite of Izzet spellcasters because of its unpredictable nature.
