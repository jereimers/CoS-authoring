...
A successful DC 15 Dexterity check using [[thieves' tools|phb]] disarms the trap, removing the needle from the lock. Unsuccessfully attempting to pick the lock triggers the trap.

---

**Source:** Dungeon Master's Guide, p. 123
