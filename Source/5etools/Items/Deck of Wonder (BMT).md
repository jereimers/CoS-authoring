...
aliases: [Deck of Wonder (BMT)]
tags: [ai_generated, 5etools, item, uncommon]
type: item
rarity: Uncommon
...
| `1d22` | Card Title |
|---|---|
| {'type': 'cell', 'roll': {'exact': 1}, 'entry': 'A ♦'} | Chancellor* |
| {'type': 'cell', 'roll': {'exact': 2}, 'entry': 'K ♦'} | Day |
| {'type': 'cell', 'roll': {'exact': 3}, 'entry': 'Q ♦'} | Night |
| {'type': 'cell', 'roll': {'exact': 4}, 'entry': 'J ♦'} | Dawn |
| {'type': 'cell', 'roll': {'exact': 5}, 'entry': '2 ♦'} | Dusk* |
| {'type': 'cell', 'roll': {'exact': 6}, 'entry': 'A ♥'} | Destiny* |
| {'type': 'cell', 'roll': {'exact': 7}, 'entry': 'K ♥'} | Crown |
| {'type': 'cell', 'roll': {'exact': 8}, 'entry': 'Q ♥'} | Lock |
| {'type': 'cell', 'roll': {'exact': 9}, 'entry': 'J ♥'} | Champion |
| {'type': 'cell', 'roll': {'exact': 10}, 'entry': '2 ♥'} | Coin* |
| {'type': 'cell', 'roll': {'exact': 11}, 'entry': 'A ♣'} | Vulture* |
| {'type': 'cell', 'roll': {'exact': 12}, 'entry': 'K ♣'} | Chaos |
| {'type': 'cell', 'roll': {'exact': 13}, 'entry': 'Q ♣'} | Order |
| {'type': 'cell', 'roll': {'exact': 14}, 'entry': 'J ♣'} | Beginning |
| {'type': 'cell', 'roll': {'exact': 15}, 'entry': '2 ♣'} | Mystery* |
| {'type': 'cell', 'roll': {'exact': 16}, 'entry': 'A ♠'} | Isolation* |
| {'type': 'cell', 'roll': {'exact': 17}, 'entry': 'K ♠'} | End |
| {'type': 'cell', 'roll': {'exact': 18}, 'entry': 'Q ♠'} | Monster |
| {'type': 'cell', 'roll': {'exact': 19}, 'entry': 'J ♠'} | Knife |
| {'type': 'cell', 'roll': {'exact': 20}, 'entry': '2 ♠'} | Justice* |
| {'type': 'cell', 'roll': {'exact': 21}, 'entry': 'Joker (with ™)'} | Student* |
| {'type': 'cell', 'roll': {'exact': 22}, 'entry': 'Joker (without ™)'} | Mischief |
