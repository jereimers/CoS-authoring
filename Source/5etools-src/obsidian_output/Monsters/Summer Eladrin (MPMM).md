...
aliases: [Summer Eladrin (MPMM)]
tags: [ai_generated, 5etools, monster, fey, cr-10]
type: monster
size: Medium
...
| **STR** 19 (+4) | **DEX** 21 (+5) | **CON** 16 (+3) | **INT** 14 (+2) | **WIS** 12 (+1) | **CHA** 18 (+4) |
...
**Longsword.** Melee Weapon Attack +8 to hit, reach 5 ft., one target. @h13 (**2d8 + 4**) slashing damage, or 15 (**2d10 + 4**) slashing damage if used with two hands, plus 9 (**2d8**) fire damage.

**Longbow.** Ranged Weapon Attack +9 to hit, range 150/600 ft., one target. @h14 (**2d8 + 5**) piercing damage plus 9 (**2d8**) fire damage.
