...
source: GoS
source_full: GoS
aliases: [Juvenile Kraken (GoS)]
tags: [ai_generated, 5etools, monster, monstrosity, cr-14]
type: monster
size: Huge
...
| **STR** 24 (+7) | **DEX** 11 (+0) | **CON** 20 (+5) | **INT** 19 (+4) | **WIS** 15 (+2) | **CHA** 17 (+3) |
...
**Tentacle.** Melee Weapon Attack +12 to hit, reach 20 ft., one target. @h17 (**3d6 + 7**) bludgeoning damage, and the target is [[grappled]] (escape DC 20). Until the grapple ends, the target is [[restrained]]. The kraken has ten tentacles, each of which can grapple one target.
