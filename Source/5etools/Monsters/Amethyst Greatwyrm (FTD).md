...
aliases: [Amethyst Greatwyrm (FTD)]
tags: [ai_generated, 5etools, monster, dragon, cr-26]
type: monster
size: Gargantuan
monster_type: dragon (gem)
alignment: Neutral
armor_class: 21
hit_points: 507
challenge_rating: 26
...
**Speed** walk 60 ft., burrow 60 ft., fly 120 ft. (hover), swim 60 ft., canHover (equal to walking)

---

| **STR** 28 (+9) | **DEX** 14 (+2) | **CON** 29 (+9) | **INT** 30 (+10) | **WIS** 24 (+7) | **CHA** 25 (+7) |
...
**Bite.** Melee Weapon Attack +17 to hit, reach 15 ft., one target. @h20 (**2d10 + 9**) piercing damage plus 16 (**3d10**) force damage.

**Claw.** Melee Weapon Attack +17 to hit, reach 10 ft., one target. @h18 (**2d8 + 9**) slashing damage. If the target is a Huge or smaller creature, it is [[grappled]] (escape DC 19) and is [[restrained]] until this grapple ends. The greatwyrm can have only one creature [[grappled]] in this way at a time.
