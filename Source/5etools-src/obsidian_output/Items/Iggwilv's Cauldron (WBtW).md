...
source: WBtW
source_full: The Wild Beyond the Witchlight
aliases: ["Iggwilv's Cauldron (WBtW)"]
...
- 1 [[Artifact Properties; Minor Beneficial Properties|dmg]] property (determined by rolling on the [[Artifact Properties; Minor Beneficial Properties|dmg]] Properties table in the Dungeon Master's Guide)
- 1 [[Artifact Properties; Minor Detrimental Properties|dmg]] property (determined by rolling on the [[Artifact Properties; Minor Detrimental Properties|dmg]] Properties table in the Dungeon Master's Guide)
...
If all eight pieces of the shattered cauldron are within 5 feet of one another, a [[wish]] spell can reassemble them, restoring the cauldron and all its properties. The cauldron's reconstruction also restores the Shared Spellcasting trait of hag covens throughout the multiverse.
