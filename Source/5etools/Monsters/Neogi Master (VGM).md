...
aliases: [Neogi Master (VGM)]
tags: [ai_generated, 5etools, monster, aberration, cr-4]
type: monster
size: Medium
...
| **STR** 6 (-2) | **DEX** 16 (+3) | **CON** 14 (+2) | **INT** 16 (+3) | **WIS** 12 (+1) | **CHA** 18 (+4) |
...
**Bite.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h6 (**1d6 + 3**) piercing damage plus 14 (**4d6**) poison damage, and the target must succeed on a DC 12 Constitution saving throw or become [[poisoned]] for 1 minute. A target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.

**Claws.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h8 (**2d4 + 3**) slashing damage.
