...
aliases: [Zaratan (MTF)]
tags: [ai_generated, 5etools, monster, elemental, cr-22]
type: monster
size: Gargantuan
...
**Earth-Shaking Movement.** As a bonus action after moving at least 10 feet on the ground, the zaratan can send a shock wave through the ground in a 120-foot-radius circle centered on itself. That area becomes difficult terrain for 1 minute. Each creature on the ground that is [[concentration]] must succeed on a DC 25 Constitution saving throw or the creature's [[concentration]] is broken.
...
**Bite.** Melee Weapon Attack +17 to hit, reach 20 ft., one target. @h28 (**4d8 + 10**) piercing damage.

**Stomp.** Melee Weapon Attack +17 to hit, reach 20 ft., one target. @h26 (**3d10 + 10**) bludgeoning damage.

**Spit Rock.** Ranged Weapon Attack +17 to hit, range 120/240 ft., one target. @h31 (**6d8 + 10**) bludgeoning damage.
