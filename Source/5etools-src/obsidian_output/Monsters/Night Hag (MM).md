...
aliases: [Night Hag (MM)]
tags: [ai_generated, 5etools, monster, fiend, cr-5]
type: monster
size: Medium
monster_type: fiend
...
**Claws (Hag Form Only).** Melee Weapon Attack +7 to hit, reach 5 ft., one target. @h13 (**2d8 + 4**) slashing damage.
