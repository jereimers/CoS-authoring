...
| **STR** 11 (+0) | **DEX** 16 (+3) | **CON** 13 (+1) | **INT** 11 (+0) | **WIS** 11 (+0) | **CHA** 13 (+1) |
...
**Scimitar.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h6 (**1d6 + 3**) slashing damage plus 3 (**1d6**) damage of the type to which the cultist has resistance.
