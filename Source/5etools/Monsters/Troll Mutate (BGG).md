...
aliases: [Troll Mutate (BGG)]
tags: [ai_generated, 5etools, monster, giant, cr-7]
type: monster
size: Large
monster_type: giant
...
**Speed** walk 30 ft., fly 30 ft. (winged form only)

---

| **STR** 19 (+4) | **DEX** 13 (+1) | **CON** 18 (+4) | **INT** 17 (+3) | **WIS** 9 (-1) | **CHA** 12 (+1) |
...
**Rend.** Melee Weapon Attack +7 to hit, reach 5 ft. (or 15 ft. if the mutate has the Elastic Body mutation), one target. @h15 (**2d10 + 4**) slashing damage plus 9 (**2d8**) force damage.

**Psychic Burst {@recharge 5}.** The mutate unleashes a wave of psychic energy. Each creature within 30 feet of the mutate must make a DC 14 Intelligence saving throw, taking 28 (**8d6**) psychic damage on a failed save, or half as much damage on a successful one.
