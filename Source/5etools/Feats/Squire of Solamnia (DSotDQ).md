...
aliases: [Squire of Solamnia (DSotDQ)]
tags: [ai_generated, 5etools, feat]
type: feat
prerequisites: 
  - "Level {'level': 1, 'class': {'name': 'Fighter', 'visible': True}}"
  - "Level {'level': 1, 'class': {'name': 'Paladin', 'visible': True}}"
---

# Squire of Solamnia

**Prerequisites:** Level {'level': 1, 'class': {'name': 'Fighter', 'visible': True}}, Level {'level': 1, 'class': {'name': 'Paladin', 'visible': True}}
