...
aliases: [Scarecrow (MM)]
tags: [ai_generated, 5etools, monster, construct, cr-1]
type: monster
size: Medium
...
**Claw.** Melee Weapon Attack +3 to hit, reach 5 ft., one target. @h6 (**2d4 + 1**) slashing damage. If the target is a creature, it must succeed on a DC 11 Wisdom saving throw or be [[frightened]] until the end of the scarecrow's next turn.
