...
aliases: [Programmed Illusion (XPHB)]
tags: [ai_generated, 5etools, spell, illusion, level-6]
type: spell
level: 6
school: Illusion
...
Physical interaction with the image reveals it to be illusory, since things can pass through it. A creature that takes the [[Study|XPHB]] action to examine the image can determine that it is an illusion with a successful Intelligence ([[Investigation|XPHB]]) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image, and any noise it makes sounds hollow to the creature.



---

**Source:** 2024 Player's Handbook, p. 309
