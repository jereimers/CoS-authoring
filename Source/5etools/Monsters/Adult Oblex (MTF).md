...
aliases: [Adult Oblex (MTF)]
tags: [ai_generated, 5etools, monster, ooze, cr-5]
type: monster
size: Medium
monster_type: ooze
...
| **STR** 8 (-1) | **DEX** 19 (+4) | **CON** 16 (+3) | **INT** 19 (+4) | **WIS** 12 (+1) | **CHA** 15 (+2) |
...
**Pseudopod.** Melee Weapon Attack +7 to hit, reach 5 ft., one target. @h7 (**1d6 + 4**) bludgeoning damage plus 5 (**2d4**) psychic damage.
