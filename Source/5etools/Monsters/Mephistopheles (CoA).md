...
source: CoA
source_full: CoA
aliases: [Mephistopheles (CoA)]
tags: [ai_generated, 5etools, monster, fiend, cr-27]
type: monster
size: Large
...
| **STR** 22 (+6) | **DEX** 23 (+6) | **CON** 22 (+6) | **INT** 30 (+10) | **WIS** 28 (+9) | **CHA** 26 (+8) |
...
**Ranseur +3.** Melee Weapon Attack +17 to hit, reach 10 ft., one target. @h20 (**2d10 + 9**) piercing damage plus 18 (**4d8**) fire or cold damage (Mephistopheles' choice).
