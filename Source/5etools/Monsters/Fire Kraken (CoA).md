...
source: CoA
source_full: CoA
aliases: [Fire Kraken (CoA)]
tags: [ai_generated, 5etools, monster, elemental, cr-21]
type: monster
size: Gargantuan
...
| **STR** 27 (+8) | **DEX** 11 (+0) | **CON** 24 (+7) | **INT** 10 (+0) | **WIS** 20 (+5) | **CHA** 15 (+2) |
...
**Damage Resistances** —  
**Damage Immunities** fire, bludgeoning, piercing, slashing  
