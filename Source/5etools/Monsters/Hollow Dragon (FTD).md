...
aliases: [Hollow Dragon (FTD)]
tags: [ai_generated, 5etools, monster, undead, cr-18]
type: monster
size: Huge
monster_type: undead
alignment: Any
...
| **STR** 23 (+6) | **DEX** 12 (+1) | **CON** 21 (+5) | **INT** 16 (+3) | **WIS** 13 (+1) | **CHA** 21 (+5) |
...
**Bite.** Melee Weapon Attack +12 to hit, reach 10 ft., one target. @h17 (**2d10 + 6**) piercing damage plus 9 (**2d8**) radiant damage.

**Claw.** Melee Weapon Attack +12 to hit, reach 5 ft., one target. @h13 (**2d6 + 6**) slashing damage.
...
**Radiant Breath {@recharge 5}.** The hollow dragon exhales radiant flames in a 60-foot cone. Each creature in that area must make a DC 19 Dexterity saving throw, taking 54 (**12d8**) radiant damage on a failed save, or half as much damage on a successful one.
