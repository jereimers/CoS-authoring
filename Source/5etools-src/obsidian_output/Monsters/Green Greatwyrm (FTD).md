...
aliases: [Green Greatwyrm (FTD)]
tags: [ai_generated, 5etools, monster, dragon, cr-27]
type: monster
size: Gargantuan
...
**Bite.** Melee Weapon Attack +18 to hit, reach 15 ft., one target. @h21 (**2d10 + 10**) piercing damage plus 13 (**2d12**) force damage.

**Claw.** Melee Weapon Attack +18 to hit, reach 10 ft., one target. @h19 (**2d8 + 10**) slashing damage. If the target is a Huge or smaller creature, it is [[grappled]] (escape DC 20) and is [[restrained]] until this grapple ends. The greatwyrm can have only one creature [[grappled]] this way at a time.

**Tail.** Melee Weapon Attack +18 to hit, reach 20 ft., one target. @h19 (**2d8 + 10**) bludgeoning damage. If the target is a creature, it must succeed on a DC 26 Strength saving throw or be knocked [[prone]].

**Breath Weapon {@recharge 5}.** The greatwyrm exhales a blast of energy in a 300-foot cone. Each creature in that area must make a DC 26 Dexterity saving throw. On a failed save, the creature takes 78 (**12d12**) poison damage. On a successful save, the creature takes half as much damage.
