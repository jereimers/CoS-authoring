...
aliases: [Duergar Mind Master (MPMM)]
...
**Armor Class** 14 ([[leather armor|PHB]])  
**Hit Points** 39 (6d8 + 12)  
**Speed** walk 25 ft.

---

| **STR** 11 (+0) | **DEX** 17 (+3) | **CON** 14 (+2) | **INT** 15 (+2) | **WIS** 10 (+0) | **CHA** 12 (+1) |
...
**Mind-Poison Dagger.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h5 (**1d4 + 3**) piercing damage plus 10 (**3d6**) psychic damage, or 1 piercing damage plus 10 (**3d6**) psychic damage while under the effect of Reduce.

**Invisibility {@recharge 4}.** The duergar magically turns [[invisible]] for up to 1 hour or until it attacks, it forces a creature to make a saving throw, or its [[concentration]] is broken (as if [[concentration]] on a spell). Any equipment the duergar wears or carries is [[invisible]] with it.
