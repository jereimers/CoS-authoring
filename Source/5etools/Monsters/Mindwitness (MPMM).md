...
aliases: [Mindwitness (MPMM)]
tags: [ai_generated, 5etools, monster, aberration, cr-5]
type: monster
size: Large
...
**Speed** fly 20 ft. (hover), canHover (equal to walking)

---

| **STR** 10 (+0) | **DEX** 14 (+2) | **CON** 14 (+2) | **INT** 15 (+2) | **WIS** 15 (+2) | **CHA** 10 (+0) |
...
**Bite.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h16 (**4d6 + 2**) piercing damage.

**Tentacles.** Melee Weapon Attack +5 to hit, reach 10 ft., one creature. @h20 (**4d8 + 2**) psychic damage. If the target is Large or smaller, it is [[grappled]] (escape DC 13), and it must succeed on a DC 13 Intelligence saving throw or be [[restrained]] until this grapple ends.
