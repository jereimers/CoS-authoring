...
| **STR** 6 (-2) | **DEX** 14 (+2) | **CON** 14 (+2) | **INT** 4 (-3) | **WIS** 7 (-2) | **CHA** 2 (-4) |
...
**Bite.** Melee Weapon Attack +4 to hit, reach 5 ft., one target. @h5 (**1d6 + 2**) piercing damage plus 10 (**3d6**) poison damage.
