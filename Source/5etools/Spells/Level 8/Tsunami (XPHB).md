...
aliases: [Tsunami (XPHB)]
tags: [ai_generated, 5etools, spell, conjuration, level-8]
type: spell
level: 8
school: Conjuration
...
A creature caught in the wall can move by swimming. Because of the wave's force, though, the creature must succeed on a Strength ([[Athletics|XPHB]]) check against your spell save DC to move at all. If it fails the check, it can't move. A creature that moves out of the wall falls to the ground.



---

**Source:** 2024 Player's Handbook, p. 336
