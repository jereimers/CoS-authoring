...
As a [[Search|XPHB]] action, a creature can examine the trapped area and make a DC 11 Wisdom ([[Perception|XPHB]]) check, detecting the trip wire and the unstable section of ceiling on a successful check. Once detected, the trip wire can be easily cut or avoided (no ability check required).
...
**Source:** 2024 Dungeon Master's Guide, p. 100
