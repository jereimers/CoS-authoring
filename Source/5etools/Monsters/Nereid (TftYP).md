...
source: TftYP
source_full: TftYP
aliases: [Nereid (TftYP)]
tags: [ai_generated, 5etools, monster, fey, cr-2]
type: monster
size: Medium
monster_type: fey
alignment: Chaotic Good NY Evil
armor_class: 13
hit_points: 44
challenge_rating: 2
xp: 450
...
*Medium fey, Chaotic Good NY Evil*
...
| **STR** 10 (+0) | **DEX** 17 (+3) | **CON** 12 (+1) | **INT** 13 (+1) | **WIS** 14 (+2) | **CHA** 16 (+3) |
...
**Blinding Acid.** Attack (ms,rs) +5 to hit, reach 5 ft. or range 30 ft., one target. @h16 (**2d12 + 3**) acid damage, and the target is [[blinded]] until the start of the nereid's next turn.
