...
aliases: [Juiblex (MPMM)]
tags: [ai_generated, 5etools, monster, fiend, cr-23]
type: monster
size: Huge
...
**Damage Immunities** acid, poison, bludgeoning, piercing, slashing  
...
**Acid Lash.** Melee or Ranged Weapon Attack +14 to hit, reach 10 ft. or range 60/120 ft., one target. @h21 (**4d6 + 7**) acid damage. Any creature killed by this attack is drawn into Juiblex's body, where the corpse is dissolved after 1 minute.
...
**Corrupting Touch (Costs 2 Actions).** Melee Weapon Attack +14 to hit, reach 10 ft., one creature. @h21 (**4d6 + 7**) poison damage, and the target is slimed. Until the slime is scraped off with an action, the target is [[poisoned]], and any creature, other than an Ooze, is [[poisoned]] while within 10 feet of the target.
