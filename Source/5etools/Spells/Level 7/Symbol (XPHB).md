...
aliases: [Symbol (XPHB)]
tags: [ai_generated, 5etools, spell, abjuration, level-7]
type: spell
level: 7
school: Abjuration
...
The glyph is nearly imperceptible and requires a successful Wisdom ([[Perception|XPHB]]) check against your spell save DC to notice.
...
Each target must succeed on a Wisdom saving throw or have the [[Frightened|XPHB]] condition for 1 minute. While [[Frightened|XPHB]], the target must move at least 30 feet away from the glyph on each of its turns, if able.

## Pain

Each target must succeed on a Constitution saving throw or have the [[Incapacitated|XPHB]] condition for 1 minute.

## Sleep

Each target must succeed on a Wisdom saving throw or have the [[Unconscious|XPHB]] condition for 10 minutes. A creature awakens if it takes damage or if someone takes an action to shake it awake.

## Stunning

Each target must succeed on a Wisdom saving throw or have the [[Stunned|XPHB]] condition for 1 minute.



---

**Source:** 2024 Player's Handbook, p. 329
