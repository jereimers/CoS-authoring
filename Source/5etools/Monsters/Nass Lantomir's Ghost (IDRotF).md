...
aliases: ["Nass Lantomir's Ghost (IDRotF)"]
...
| **STR** 7 (-2) | **DEX** 13 (+1) | **CON** 10 (+0) | **INT** 17 (+3) | **WIS** 12 (+1) | **CHA** 17 (+3) |
...
**Withering Touch.** Melee Weapon Attack +6 to hit, reach 5 ft., one target. @h17 (**4d6 + 3**) necrotic damage.
