...
aliases: [Animated Object (Small) (PHB)]
...
| **STR** 6 (-2) | **DEX** 14 (+2) | **CON** 10 (+0) | **INT** 3 (-4) | **WIS** 3 (-4) | **CHA** 1 (-5) |
...
**Slam.** Melee Weapon Attack +6 to hit, reach 5 ft., one target. @h6 (**1d8 + 2**) bludgeoning damage.
