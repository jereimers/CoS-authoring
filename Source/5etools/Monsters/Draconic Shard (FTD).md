...
**Speed** fly 80 ft. (hover), canHover (equal to walking)

---

| **STR** 1 (-5) | **DEX** 12 (+1) | **CON** 18 (+4) | **INT** 22 (+6) | **WIS** 18 (+4) | **CHA** 22 (+6) |
...
**Telekinetic Rend.** Attack (ms,rs) +12 to hit, reach 10 ft. or range 120 ft., one target. @h15 (**2d8 + 6**) force damage.
