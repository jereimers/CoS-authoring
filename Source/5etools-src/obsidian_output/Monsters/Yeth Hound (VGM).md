...
aliases: [Yeth Hound (VGM)]
tags: [ai_generated, 5etools, monster, fey, cr-4]
type: monster
size: Large
monster_type: fey
...
| **STR** 18 (+4) | **DEX** 17 (+3) | **CON** 16 (+3) | **INT** 5 (-3) | **WIS** 12 (+1) | **CHA** 7 (-2) |
...
**Bite.** Melee Weapon Attack +6 to hit, reach 5 ft., one target. @h11 (**2d6 + 4**) piercing damage, plus 14 (**4d6**) psychic damage if the target is [[frightened]].
