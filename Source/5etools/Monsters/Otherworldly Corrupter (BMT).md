...
aliases: [Otherworldly Corrupter (BMT)]
tags: [ai_generated, 5etools, monster, aberration, cr-17]
type: monster
size: Small, Medium
...
*Small, Medium aberration, Chaotic Evil*
...
| **STR** 12 (+1) | **DEX** 22 (+6) | **CON** 16 (+3) | **INT** 22 (+6) | **WIS** 18 (+4) | **CHA** 20 (+5) |
...
**Whispering Blade.** Melee or Ranged Weapon Attack +12 to hit, reach 5 ft. or range 60 ft., one target. @h10 (**1d8 + 6**) piercing damage plus 14 (**4d6**) psychic damage. If the target is a creature, it must succeed on a DC 20 Wisdom saving throw or be unable to speak until the start of the corrupter's next turn.
