...
source: OotA
source_full: OotA
aliases: [Chamberlain of Zuggtmoy (OotA)]
...
| **STR** 17 (+3) | **DEX** 7 (-2) | **CON** 14 (+2) | **INT** 11 (+0) | **WIS** 8 (-1) | **CHA** 12 (+1) |
...
**Slam.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h10 (**2d6 + 3**) bludgeoning damage.
