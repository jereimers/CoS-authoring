...
aliases: [Froghemoth (MPMM)]
tags: [ai_generated, 5etools, monster, monstrosity, cr-10]
type: monster
size: Huge
...
**Bite.** Melee Weapon Attack +10 to hit, reach 5 ft., one target. @h22 (**3d10 + 6**) piercing damage, and the target is swallowed if it is a Medium or smaller creature. A swallowed creature is [[blinded]] and [[restrained]], has Cover against attacks and other effects outside the froghemoth, and takes 10 (**3d6**) acid damage at the start of each of the froghemoth's turns.
...
**Tentacle.** Melee Weapon Attack +10 to hit, reach 20 ft., one target. @h19 (**3d8 + 6**) bludgeoning damage, and the target is [[grappled]] (escape DC 16) if it is a Huge or smaller creature. Until the grapple ends, the froghemoth can't use this tentacle on another target. The froghemoth has four tentacles.
