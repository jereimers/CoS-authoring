...
- **Equipment::** A bottle of black ink, an [[ink pen|PHB]], five sheets of paper, a [[gaming set|PHB]] (matching your chosen proficiency), a [[Source/5e-database/obsidian_output/Equipment/AdventuringGear/Signet ring|PHB]], a set of [[fine clothes|PHB]], and a [[pouch|PHB]] containing 18 gp
- **Tool Proficiencies::** One gaming set of your choice (such as [[playing card set|phb]] or [[three-dragon ante set|phb]])
...
When you make your character, you can roll once on the Rewarded Trinkets table instead of on the Trinkets table in the [[Player's Handbook|PHB]] for your starting trinket.
