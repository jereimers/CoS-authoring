...
aliases: [Silverquill Professor of Shadow (SCC)]
...
*Small, Medium humanoid (bard), Any*
...
| **STR** 11 (+0) | **DEX** 14 (+2) | **CON** 14 (+2) | **INT** 16 (+3) | **WIS** 13 (+1) | **CHA** 19 (+4) |
...
**Ink Lance.** Attack (ms,rs) +7 to hit, reach 5 ft. or range 120 ft., one target. @h17 (**3d8 + 4**) necrotic damage. If the target is a creature, it must succeed on a DC 15 Constitution saving throw be [[blinded]] until the end of its next turn.
