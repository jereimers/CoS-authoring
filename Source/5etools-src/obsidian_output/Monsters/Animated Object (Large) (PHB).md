...
aliases: [Animated Object (Large) (PHB)]
tags: [ai_generated, 5etools, monster, construct, cr-0]
type: monster
size: Large
...
| **STR** 14 (+2) | **DEX** 10 (+0) | **CON** 10 (+0) | **INT** 3 (-4) | **WIS** 3 (-4) | **CHA** 1 (-5) |
...
**Slam.** Melee Weapon Attack +6 to hit, reach 5 ft., one target. @h12 (**2d10 + 2**) bludgeoning damage.
