...
aliases: [Trostani (GGR)]
tags: [ai_generated, 5etools, monster, fey, cr-18]
type: monster
size: Large
monster_type: fey
...
| **STR** 19 (+4) | **DEX** 14 (+2) | **CON** 20 (+5) | **INT** 16 (+3) | **WIS** 30 (+10) | **CHA** 25 (+7) |
...
**Constrict.** Melee Weapon Attack +11 to hit, reach 5 ft., one creature. @h15 (**3d6 + 5**) bludgeoning damage, and the target is [[grappled]] (escape DC 19). Until this grapple ends, the target is [[restrained]]. Trostani can grapple no more than three targets at a time.

**Touch of Order.** Melee Spell Attack +16 to hit, reach 5 ft., one creature. @h23 (**3d8 + 10**) radiant damage, and Trostani can choose one magic item she can see in the target's possession. Unless it's an artifact, the item's magic is suppressed until the start of Trostani's next turn.
