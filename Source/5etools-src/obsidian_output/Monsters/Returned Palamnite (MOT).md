...
aliases: [Returned Palamnite (MOT)]
tags: [ai_generated, 5etools, monster, undead, cr-4]
type: monster
size: Medium
monster_type: undead
...
| **STR** 10 (+0) | **DEX** 17 (+3) | **CON** 14 (+2) | **INT** 13 (+1) | **WIS** 12 (+1) | **CHA** 15 (+2) |
...
**Shortsword.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h6 (**1d6 + 3**) piercing damage plus 10 (**3d6**) poison damage.
