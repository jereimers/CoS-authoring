...
aliases: [Oinoloth (MTF)]
tags: [ai_generated, 5etools, monster, fiend, cr-12]
type: monster
size: Medium
...
| **STR** 19 (+4) | **DEX** 17 (+3) | **CON** 18 (+4) | **INT** 17 (+3) | **WIS** 16 (+3) | **CHA** 19 (+4) |
...
**Claw.** Melee Weapon Attack +8 to hit, reach 5 ft., one target. @h14 (**3d6 + 4**) slashing damage plus 22 (**4d10**) necrotic damage.
