...
aliases: [Silver Greatwyrm (FTD)]
tags: [ai_generated, 5etools, monster, dragon, cr-28]
type: monster
size: Gargantuan
...
| **STR** 30 (+10) | **DEX** 16 (+3) | **CON** 29 (+9) | **INT** 21 (+5) | **WIS** 22 (+6) | **CHA** 30 (+10) |
...
**Claw.** Melee Weapon Attack +18 to hit, reach 10 ft., one target. @h19 (**2d8 + 10**) slashing damage. If the target is a Huge or smaller creature, it is [[grappled]] (escape DC 20) and is [[restrained]] until this grapple ends. The greatwyrm can have only one creature [[grappled]] in this way at a time.

**Tail.** Melee Weapon Attack +18 to hit, reach 20 ft., one target. @h21 (**2d10 + 10**) bludgeoning damage. If the target is a creature, it must succeed on a DC 26 Strength saving throw or be knocked [[prone]].
