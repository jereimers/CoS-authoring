...
aliases: [Wish (XPHB)]
tags: [ai_generated, 5etools, spell, conjuration, level-9]
type: spell
level: 9
school: Conjuration
...
- **Instant Health:** You allow yourself and up to twenty creatures that you can see to regain all [[Hit Points|XPHB]], and you end all effects on them listed in the [[Greater Restoration|XPHB]] spell.
- **Resistance:** You grant up to ten creatures that you can see [[Resistance|XPHB]] to one damage type that you choose. This [[Resistance|XPHB]] is permanent.
...
- **Roll Redo:** You undo a single recent event by forcing a reroll of any die roll made within the last round (including your last turn). Reality reshapes itself to accommodate the new result. For example, a Wish spell could undo an ally's failed saving throw or a foe's [[Critical Hit|XPHB]]. You can force the reroll to be made with [[Advantage|XPHB]] or [[Disadvantage|XPHB]], and you choose whether to use the reroll or the original roll.
...
The stress of casting Wish to produce any effect other than duplicating another spell weakens you. After enduring that stress, each time you cast a spell until you finish a [[Long Rest|XPHB]], you take **1d10** Necrotic damage per level of that spell. This damage can't be reduced or prevented in any way. In addition, your Strength score becomes 3 for `2d4` days. For each of those days that you spend resting and doing nothing more than light activity, your remaining recovery time decreases by 2 days. Finally, there is a 33% chance that you are unable to cast [[Wish|XPHB]] ever again if you suffer this stress.



---

**Source:** 2024 Player's Handbook, p. 341
