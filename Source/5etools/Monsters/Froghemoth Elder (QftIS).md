...
source: QftIS
source_full: QftIS
aliases: [Froghemoth Elder (QftIS)]
tags: [ai_generated, 5etools, monster, monstrosity, cr-15]
type: monster
size: Huge
...
| **STR** 25 (+7) | **DEX** 13 (+1) | **CON** 20 (+5) | **INT** 2 (-4) | **WIS** 14 (+2) | **CHA** 8 (-1) |
...
**Bite.** Melee Weapon Attack +12 to hit, reach 5 ft., one target. @h23 (**3d10 + 7**) piercing damage, and the target is swallowed if it is a Medium or smaller creature. A swallowed creature has the [[blinded]] and [[restrained]] conditions, has Cover against attacks and other effects outside the froghemoth, and takes 10 (**3d6**) acid damage at the start of each of the froghemoth's turns.
...
**Tentacle.** Melee Weapon Attack +12 to hit, reach 20 ft., one target. @h20 (**3d8 + 7**) bludgeoning damage, and the target has the [[grappled]] condition (escape DC 20). Until this grapple ends, the froghemoth can't use this tentacle on another target. The froghemoth has four tentacles.
