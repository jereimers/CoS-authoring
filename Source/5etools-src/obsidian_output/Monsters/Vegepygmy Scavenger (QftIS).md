...
source: QftIS
source_full: QftIS
aliases: [Vegepygmy Scavenger (QftIS)]
tags: [ai_generated, 5etools, monster, plant, cr-1/4]
type: monster
size: Small
monster_type: plant
alignment: Neutral
...
| **STR** 7 (-2) | **DEX** 14 (+2) | **CON** 13 (+1) | **INT** 6 (-2) | **WIS** 11 (+0) | **CHA** 7 (-2) |
...
**Claw.** Melee Weapon Attack +4 to hit, reach 5 ft., one target. @h5 (**1d6 + 2**) slashing damage.
