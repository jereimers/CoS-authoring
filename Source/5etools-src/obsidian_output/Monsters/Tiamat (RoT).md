...
source_full: RoT
aliases: [Tiamat (RoT)]
tags: [ai_generated, 5etools, monster, fiend, cr-30]
type: monster
size: Gargantuan
monster_type: fiend
...
**Damage Resistances** —  
**Damage Immunities** acid, cold, fire, lightning, poison, bludgeoning, piercing, slashing  
...
**Claw.** Melee Weapon Attack +19 to hit, reach 15 ft., one target. @h24 (**4d6 + 10**) slashing damage.

**Tail.** Melee Weapon Attack +19 to hit, reach 25 ft., one target. @h28 (**4d8 + 10**) piercing damage.
...
**Bite.** Melee Weapon Attack +19 to hit, reach 20 ft., one target. @h32 (**4d10 + 10**) slashing damage plus 14 (**4d6**) acid damage (black dragon head), lightning damage (blue dragon head), poison damage (green dragon head), fire damage (red dragon head), or cold damage (white dragon head).
