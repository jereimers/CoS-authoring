...
aliases: [Young Kruthik (MPMM)]
tags: [ai_generated, 5etools, monster, monstrosity, cr-1/8]
type: monster
size: Small
...
| **STR** 13 (+1) | **DEX** 16 (+3) | **CON** 13 (+1) | **INT** 4 (-3) | **WIS** 10 (+0) | **CHA** 6 (-2) |
...
**Stab.** Melee Weapon Attack +5 to hit, reach 5 ft., one target. @h5 (**1d4 + 3**) piercing damage.
