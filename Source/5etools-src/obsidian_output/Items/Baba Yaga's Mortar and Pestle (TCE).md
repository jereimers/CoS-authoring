...
aliases: ["Baba Yaga's Mortar and Pestle (TCE)"]
...
This artifact has the following random properties, which you can determine by rolling on the tables in the "Artifacts" section of the [[Dungeon Master's Guide|DMG]]:
...
You can also use the artifact as [[alchemist's supplies|PHB]], [[brewer's supplies|PHB]], [[cook's utensils|PHB]], an [[herbalism kit|PHB]], and a [[poisoner's kit|PHB]]. You have advantage on any check you make using the artifact as one of these tools.
