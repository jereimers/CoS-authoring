...
aliases: [Warlock of the Great Old One (VGM)]
...
| **STR** 9 (-1) | **DEX** 14 (+2) | **CON** 15 (+2) | **INT** 12 (+1) | **WIS** 12 (+1) | **CHA** 18 (+4) |
...
**Dagger.** Melee or Ranged Weapon Attack +5 to hit, reach 5 ft. or range 20/60 ft., one target. @h4 (**1d4 + 2**) piercing damage.
