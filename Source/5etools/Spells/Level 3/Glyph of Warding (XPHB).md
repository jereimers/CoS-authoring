...
aliases: [Glyph of Warding (XPHB)]
tags: [ai_generated, 5etools, spell, abjuration, level-3]
type: spell
level: 3
school: Abjuration
casting_time: 1 hour
...
When the glyph is triggered, the stored spell takes effect. If the spell has a target, it targets the creature that triggered the glyph. If the spell affects an area, the area is centered on that creature. If the spell summons [[Hostile [Attitude]|XPHB]] creatures or creates harmful objects or traps, they appear as close as possible to the intruder and attack it. If the spell requires [[Concentration]], it lasts until the end of its full duration.
...
**Source:** 2024 Player's Handbook, p. 279
