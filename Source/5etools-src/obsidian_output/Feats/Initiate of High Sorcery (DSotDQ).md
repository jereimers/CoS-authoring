...
aliases: [Initiate of High Sorcery (DSotDQ)]
tags: [ai_generated, 5etools, feat]
type: feat
prerequisites: 
  - "Level {'level': 1, 'class': {'name': 'Sorcerer', 'visible': True}}"
  - "Level {'level': 1, 'class': {'name': 'Wizard', 'visible': True}}"
---

# Initiate of High Sorcery

**Prerequisites:** Level {'level': 1, 'class': {'name': 'Sorcerer', 'visible': True}}, Level {'level': 1, 'class': {'name': 'Wizard', 'visible': True}}
